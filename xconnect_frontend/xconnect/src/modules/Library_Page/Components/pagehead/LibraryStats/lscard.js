...
function Lscard({name, icon, counting}) {
  return (
    <div style={{ width: '77vh', height: 'auto', margin: '2rem', backgroundColor: '#3B3B3B',border: 'solid 2px rgb(23, 104, 227)' , borderRadius: '10px', padding: '10px', textAlign:'center', display:'flex', flexDirection:'column' }}>
